					...
					<div className="flex flex-col gap-6 px-6 py-2">
						...
						<div className="flex flex-col gap-2">
							...
							<div className="flex items-center justify-between flex-wrap gap-2">
								<div className="flex w-[45%] items-center justify-between text-sm text-text-disabled">
								...
								<div className="flex w-[45%] items-center justify-between text-sm text-text-disabled">
									<Text variant="subTitle2">{t("sys.settings.group")}</Text>
									<Switch checked={group} onCheckedChange={(checked) => updateSettings({ group: checked })} />
								</div>
								{/* <div className="flex w-[48%] items-center justify-between text-sm text-text-disabled">
								...
								<div className="flex w-[45%] items-center justify-between text-sm text-text-disabled">
									<Text variant="subTitle2">{t("sys.settings.accordion")}</Text>
